...
#This is a modification of Snuggle's code. I just removed some things and added a function that retrieves a player's Bedwars level. Still all credit goes to Snuggle for this neat wrapper.
